...
namespace DAL
{
    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await _context.TradePreclearanceRequests.AnyAsync())
            {

                TradePreclearanceRequest request = new TradePreclearanceRequest
                {
                ...
                _context.TradePreclearanceRequests.Add(request);
                await _context.SaveChangesAsync();
            }


            if (!await _context.ItemOfInterests.AnyAsync())
            {

                ItemOfInterest itemOfInterest1 = new ItemOfInterest
                {

                    CreatedBy = Environment.UserName,
                    TradePreclearanceRequestId=1,
                    Description="Trade not precleared and on restricted list",
                    IoiType="PotentialViolation",
                    CreatedDate = DateTime.UtcNow,
                    Status = "Open",
                    UpdatedBy = string.Empty,
                    UpdatedDate = DateTime.UtcNow
                ...
                ItemOfInterest itemOfInterest2 = new ItemOfInterest
                {

                    CreatedBy = Environment.UserName,
                    TradePreclearanceRequestId = 2,
                    Description = "New Employee attestation complete",
                    IoiType = "Notification",
                    CreatedDate = DateTime.UtcNow,
                    Status = "Open",
                    UpdatedBy = string.Empty,
                    UpdatedDate = DateTime.UtcNow
                };
                ItemOfInterest itemOfInterest3 = new ItemOfInterest
                {

                    CreatedBy = Environment.UserName,
                    TradePreclearanceRequestId = 3,
                    Description = "Social media use violation",
                    IoiType = "Alert",
                    CreatedDate = DateTime.UtcNow,
                    Status = "Open",
                    UpdatedBy = string.Empty,
                ...
                _context.ItemOfInterests.Add(itemOfInterest1);
                _context.ItemOfInterests.Add(itemOfInterest2);
                _context.ItemOfInterests.Add(itemOfInterest3);
