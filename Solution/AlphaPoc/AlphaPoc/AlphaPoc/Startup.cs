...
using AlphaPoc.Helpers;
using AlphaPoc.Authorization;
...
namespace AlphaPoc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("AlphaPoc"));
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "AlphaPoc API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "AlphaPoc API V1");
            });
